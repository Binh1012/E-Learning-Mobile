...
import '../../reading_practice/reading_practice_screen.dart';
import '../../../core/services/auth_service.dart';

class ReadingPracticeTab extends StatefulWidget {
  const ReadingPracticeTab({Key? key}) : super(key: key);

  @override
  State<ReadingPracticeTab> createState() => _ReadingPracticeTabState();
}

class _ReadingPracticeTabState extends State<ReadingPracticeTab> {
  // API Configuration
  ...
  Future<void> _loadGrammarLessons() async {
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('$API_BASE_URL/grammar/lessons?categoryId=3'),
        headers: {
        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => ReadingPracticeScreen(
              readingTitle: lesson['title'],
              readingLevel: lesson['level'],
